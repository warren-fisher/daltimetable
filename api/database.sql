...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10047, 5, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20054, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20056, 6, 'TR', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10181, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20165, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20176, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10235, 5, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10236, 5, 'T', TIME(STR_TO_DATE('1505', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10237, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10238, 5, 'W', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10239, 5, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10240, 5, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10242, 5, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10244, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10245, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10246, 5, 'W', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10247, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10248, 5, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10249, 5, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10250, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10251, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10252, 5, 'W', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10253, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10256, 5, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10257, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10258, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10259, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10260, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10261, 5, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10262, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10263, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10264, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10265, 5, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10266, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10269, 5, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10270, 5, 'F', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10271, 5, 'W', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10272, 5, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10273, 5, 'T', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10274, 5, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10275, 5, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10276, 5, 'W', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10277, 5, 'T', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10278, 5, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10279, 5, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10280, 5, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10281, 5, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10284, 5, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10285, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10286, 5, 'W', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10287, 5, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10288, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10291, 5, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10292, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10293, 5, 'W', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10294, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10295, 5, 'R', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14241, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10299, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10300, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10301, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10309, 5, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10310, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10312, 5, 'F', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10313, 5, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10315, 5, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10317, 5, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10319, 5, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10320, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10321, 5, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10322, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10325, 5, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10331, 5, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0925', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20216, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20217, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20218, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20219, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20220, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20221, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20222, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20223, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20224, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20226, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20227, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20228, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20229, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20230, 6, 'W', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20231, 6, 'R', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20232, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20233, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20234, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20235, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20237, 6, 'R', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20240, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20241, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20242, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20243, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20244, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20245, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20246, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20247, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20248, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20249, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20250, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20253, 6, 'M', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20254, 6, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20255, 6, 'W', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20256, 6, 'R', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20257, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20258, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20259, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20260, 6, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20261, 6, 'W', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20262, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20263, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20264, 6, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20267, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20268, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20269, 6, 'W', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20270, 6, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20271, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20274, 6, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20275, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20276, 6, 'W', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20277, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20278, 6, 'R', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20279, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20285, 6, 'TR', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20286, 6, 'TR', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20287, 6, 'WF', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20288, 6, 'MW', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20290, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20292, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20294, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20299, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20301, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20302, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20305, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20308, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20309, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20310, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20311, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20312, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13175, 5, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1205', '%k%i')), TIME(STR_TO_DATE('1355', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13193, 5, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13198, 5, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10374, 5, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24176, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20346, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20347, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20349, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20350, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20352, 6, 'R', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20354, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20356, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20358, 6, 'R', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20360, 6, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20366, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20368, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24177, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10442, 5, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10443, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10444, 5, 'R', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1355', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10445, 5, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10446, 5, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10450, 5, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10451, 5, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10452, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10455, 5, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10456, 5, 'T', TIME(STR_TO_DATE('1405', '%k%i')),
        TIME(STR_TO_DATE('1655', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10457, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10458, 5, 'R', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10459, 5, 'R', TIME(STR_TO_DATE('1405', '%k%i')),
        TIME(STR_TO_DATE('1655', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10460, 5, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10461, 5, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10465, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10467, 5, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10471, 5, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1655', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10473, 5, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10475, 5, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20412, 6, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1655', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20413, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20416, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20417, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20418, 6, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20422, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20423, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20424, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20425, 6, 'T', TIME(STR_TO_DATE('1405', '%k%i')),
        TIME(STR_TO_DATE('1655', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20426, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20432, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20434, 6, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20471, 6, 'M', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20473, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20475, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20477, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20478, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1535', '%k%i')), TIME(STR_TO_DATE('1725', '%k%i')), 2);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20481, 6, 'R', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20483, 6, 'W', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20485, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20487, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20489, 6, 'M', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20491, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20494, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20529, 6, 'M', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20530, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20562, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1805', '%k%i')), TIME(STR_TO_DATE('1925', '%k%i')), 1.5);

INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20621, 6, 'W', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10778, 5, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10779, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10780, 5, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10781, 5, 'M', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10782, 5, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10783, 5, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10834, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10835, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20638, 6, 'W', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20639, 6, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20641, 6, 'MW', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20642, 6, 'WF', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20643, 6, 'MW', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20644, 6, 'TR', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20645, 6, 'TR', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20647, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20648, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20652, 6, 'F', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20653, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20654, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20655, 6, 'W', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20656, 6, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20657, 6, 'F', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24166, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24167, 6, 'F', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20661, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20662, 6, 'F', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24305, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24307, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24308, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23992, 6, 'M', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23993, 6, 'R', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23994, 6, 'T', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20665, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20666, 6, 'M', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20667, 6, 'F', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20668, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20669, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20670, 6, 'M', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20671, 6, 'M', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20672, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20673, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20674, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20675, 6, 'R', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20676, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20677, 6, 'W', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20678, 6, 'M', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20679, 6, 'T', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20680, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20681, 6, 'W', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20682, 6, 'R', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20683, 6, 'W', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20684, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20688, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20689, 6, 'M', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20690, 6, 'M', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20694, 6, 'W', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20695, 6, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20696, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20699, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20700, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20701, 6, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20702, 6, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20705, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20706, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20707, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20708, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20709, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20711, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20713, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20714, 6, 'W', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24091, 6, 'TR', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1735', '%k%i')), TIME(STR_TO_DATE('1855', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10884, 5, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10886, 5, 'F', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1055', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1205', '%k%i')), TIME(STR_TO_DATE('1255', '%k%i')), 3);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10890, 5, 'TR', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10892, 5, 'W', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('0805', '%k%i')), TIME(STR_TO_DATE('1555', '%k%i')), 12);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20784, 6, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1455', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20786, 6, 'F', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1055', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20788, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11239, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11243, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11245, 5, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21087, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21090, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21092, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21095, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24085, 6, 'R', TIME(STR_TO_DATE('1505', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21100, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0955', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21105, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1655', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21111, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21112, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20846, 6, 'T', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20847, 6, 'T', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20848, 6, 'W', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20849, 6, 'W', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20850, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20851, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20852, 6, 'W', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20853, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20854, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20855, 6, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20856, 6, 'W', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20857, 6, 'W', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20858, 6, 'R', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20859, 6, 'R', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20860, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20861, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20862, 6, 'R', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20863, 6, 'R', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20864, 6, 'R', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20865, 6, 'T', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20866, 6, 'W', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20867, 6, 'R', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20868, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20869, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24016, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24017, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24018, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24019, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20888, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20890, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10897, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10898, 5, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10899, 5, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10900, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10901, 5, 'T', TIME(STR_TO_DATE('1835', '%k%i')),
        TIME(STR_TO_DATE('2125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10903, 5, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10905, 5, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10908, 5, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10910, 5, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10912, 5, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10914, 5, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10916, 5, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14492, 5, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10918, 5, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10920, 5, 'M', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10922, 5, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10927, 5, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10929, 5, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (10931, 5, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13341, 5, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20796, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20797, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20799, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20800, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20808, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20810, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24266, 6, 'M', TIME(STR_TO_DATE('1505', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20814, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24213, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20816, 6, 'M', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20820, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20822, 6, 'M', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20824, 6, 'M', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23039, 6, 'R', TIME(STR_TO_DATE('1405', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20916, 6, 'F', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20917, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20918, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20919, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20920, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20921, 6, 'W', TIME(STR_TO_DATE('1905', '%k%i')),
        TIME(STR_TO_DATE('2155', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20922, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20923, 6, 'R', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20925, 6, 'M', TIME(STR_TO_DATE('1835', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20927, 6, 'F', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20933, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20934, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20935, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20936, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20937, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20939, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20940, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20941, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20998, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21000, 6, 'F', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21002, 6, 'M', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21005, 6, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21007, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21009, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23068, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20946, 6, 'R', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20947, 6, 'R', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20948, 6, 'R', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20949, 6, 'R', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20952, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20953, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20954, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20955, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23926, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23927, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23928, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23929, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20961, 6, 'F', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20962, 6, 'F', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20963, 6, 'F', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20964, 6, 'F', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20966, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20967, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20968, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24022, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0925', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20972, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20973, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20974, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (20975, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21040, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23988, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21042, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('0935', '%k%i')), TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11205, 5, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21059, 6, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21062, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24282, 6, 'M', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21065, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0955', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1435', '%k%i')), TIME(STR_TO_DATE('1605', '%k%i')), 3);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1205', '%k%i')), TIME(STR_TO_DATE('1405', '%k%i')), 3);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13404, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1425', '%k%i')), TIME(STR_TO_DATE('1735', '%k%i')), 3);

INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        C_TIMEEND, C_CREDIT_HRS) VALUES (24449, 6, '5041', 'Environmental Education', 'ENVI', 'F',
        TIME(STR_TO_DATE('0825', '%k%i')), TIME(STR_TO_DATE('1135', '%k%i')), 3);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21130, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23099, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21223, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24192, 6, 'M', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21170, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21171, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21173, 6, 'W', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21174, 6, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21175, 6, 'R', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24023, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24024, 6, 'M', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21179, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21180, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11373, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11374, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11375, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11376, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11378, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11379, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11380, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11381, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21190, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21191, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21192, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21193, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21194, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21195, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21196, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21197, 6, 'M', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21198, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21199, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21201, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21202, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21203, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21204, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21206, 6, 'M', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21207, 6, 'M', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21208, 6, 'W', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1205', '%k%i')), TIME(STR_TO_DATE('1425', '%k%i')), 1.5);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11504, 5, 'W', TIME(STR_TO_DATE('1505', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21315, 6, 'T', TIME(STR_TO_DATE('1405', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21316, 6, 'R', TIME(STR_TO_DATE('1405', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23706, 6, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23707, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23709, 6, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23710, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21250, 6, 'T', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21251, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21252, 6, 'R', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21253, 6, 'R', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21254, 6, 'W', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23698, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23697, 6, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21267, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21268, 6, 'M', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21351, 6, 'M', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21353, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21355, 6, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21357, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21359, 6, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21363, 6, 'F', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24278, 6, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21365, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21369, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23713, 6, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24279, 6, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24280, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24281, 6, 'M', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21392, 6, 'W', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21393, 6, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21394, 6, 'R', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21395, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21396, 6, 'W', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21400, 6, 'T', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('0935', '%k%i')), TIME(STR_TO_DATE('1155', '%k%i')), 3);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14023, 5, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14024, 5, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14025, 5, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14026, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14027, 5, 'R', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14028, 5, 'R', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23719, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23720, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23721, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23722, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23723, 6, 'R', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23724, 6, 'R', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11685, 5, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13535, 5, 'W', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21434, 6, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21435, 6, 'M', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21436, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21437, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21438, 6, 'F', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21439, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21440, 6, 'F', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21441, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21442, 6, 'F', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21446, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0955', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21447, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21448, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21449, 6, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21450, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0955', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21451, 6, 'R', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21452, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21453, 6, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21455, 6, 'M', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0955', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21456, 6, 'M', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21457, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21458, 6, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21459, 6, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0955', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21460, 6, 'W', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21461, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21463, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21464, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21465, 6, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21466, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21467, 6, 'R', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21468, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21469, 6, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21470, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21476, 6, 'F', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21477, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21478, 6, 'F', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21481, 6, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('0955', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21482, 6, 'W', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21483, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21484, 6, 'W', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21485, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24112, 6, 'MWRF', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24113, 6, 'MWRF', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24114, 6, 'MWF', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('0935', '%k%i')), TIME(STR_TO_DATE('1225', '%k%i')), 6);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11930, 5, 'R', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11957, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21703, 6, 'M', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21704, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21712, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21713, 6, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21714, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21755, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13549, 5, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11721, 5, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11722, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21521, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21523, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21524, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21529, 6, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21530, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11841, 5, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11842, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21648, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21649, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21651, 6, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21609, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21610, 6, 'R', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21611, 6, 'T', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21612, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21613, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21617, 6, 'M', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21622, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21623, 6, 'M', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11847, 5, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11848, 5, 'R', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11850, 5, 'R', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11851, 5, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11853, 5, 'W', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11854, 5, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11855, 5, 'M', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11857, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11860, 5, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11861, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1105', '%k%i')), TIME(STR_TO_DATE('1225', '%k%i')), 5);

INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11865, 5, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11867, 5, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11868, 5, 'M', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11874, 5, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11875, 5, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11876, 5, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11880, 5, 'M', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11881, 5, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21659, 6, 'R', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21660, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21662, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21664, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21665, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1205', '%k%i')), TIME(STR_TO_DATE('1325', '%k%i')), 5);

INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21667, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21673, 6, 'M', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21674, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21688, 6, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21689, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21690, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11987, 5, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11988, 5, 'T', TIME(STR_TO_DATE('1835', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11990, 5, 'R', TIME(STR_TO_DATE('1835', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (11991, 5, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21791, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21792, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21808, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21809, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21811, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21813, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21816, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21818, 6, 'M', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21820, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21822, 6, 'M', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21825, 6, 'F', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (21827, 6, 'R', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1435', '%k%i')), TIME(STR_TO_DATE('1825', '%k%i')), 3);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1435', '%k%i')), TIME(STR_TO_DATE('1655', '%k%i')), 3);

INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        C_TIMEEND, C_CREDIT_HRS) VALUES (14482, 5, '4225', 'Science of Mindfulness', 'NESC', 'R',
        TIME(STR_TO_DATE('1005', '%k%i')), TIME(STR_TO_DATE('1155', '%k%i')), 3);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22086, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22089, 6, 'M', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1055', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22091, 6, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22093, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12321, 5, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12322, 5, 'R', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12324, 5, 'M', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12325, 5, 'W', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12327, 5, 'T', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12328, 5, 'R', TIME(STR_TO_DATE('1405', '%k%i')),
        TIME(STR_TO_DATE('1455', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12330, 5, 'T', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12332, 5, 'W', TIME(STR_TO_DATE('0905', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12334, 5, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12336, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12338, 5, 'W', TIME(STR_TO_DATE('0905', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22107, 6, 'R', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1355', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22109, 6, 'M', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22110, 6, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1755', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22112, 6, 'T', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22113, 6, 'R', TIME(STR_TO_DATE('0905', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22115, 6, 'T', TIME(STR_TO_DATE('1035', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22117, 6, 'T', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1355', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22119, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22121, 6, 'T', TIME(STR_TO_DATE('0905', '%k%i')),
        TIME(STR_TO_DATE('1025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22123, 6, 'T', TIME(STR_TO_DATE('1405', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22125, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12357, 5, 'T', TIME(STR_TO_DATE('0905', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12368, 5, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12388, 5, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        C_TIMEEND, C_CREDIT_HRS) VALUES (22131, 6, '2725', 'Clinical Integration II', 'NURS', 'R',
        TIME(STR_TO_DATE('0705', '%k%i')), TIME(STR_TO_DATE('0855', '%k%i')), 3);

INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22133, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22136, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22137, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22138, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22139, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22140, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22141, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22142, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22143, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22148, 6, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22149, 6, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22150, 6, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22151, 6, 'T', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22156, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22157, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22158, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22159, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22160, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22161, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22162, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22163, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('0735', '%k%i')), TIME(STR_TO_DATE('0825', '%k%i')), 6);

INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22165, 6, 'W', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1735', '%k%i')), TIME(STR_TO_DATE('2025', '%k%i')), 6);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12430, 5, 'W', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22192, 6, 'W', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22207, 6, 'TR', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23366, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22213, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22214, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22216, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22217, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22218, 6, 'F', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1205', '%k%i')), TIME(STR_TO_DATE('1325', '%k%i')), 9);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22225, 6, 'MWF', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22228, 6, 'RF', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23934, 6, 'MW', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1135', '%k%i')), TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1235', '%k%i')), TIME(STR_TO_DATE('1325', '%k%i')), 6);

INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22234, 6, 'MWF', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22236, 6, 'MWF', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22238, 6, 'MWF', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1235', '%k%i')), TIME(STR_TO_DATE('1325', '%k%i')), 1.5);

INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22240, 6, 'MWF', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22243, 6, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22245, 6, 'MWF', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22247, 6, 'MWF', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22249, 6, 'MWF', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22251, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1135', '%k%i')), TIME(STR_TO_DATE('1225', '%k%i')), 1.5);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22312, 6, 'M', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22314, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22317, 6, 'T', TIME(STR_TO_DATE('1905', '%k%i')),
        TIME(STR_TO_DATE('1955', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22319, 6, 'MW', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22321, 6, 'TR', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22330, 6, 'TR', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (24004, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13759, 5, 'F', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13761, 5, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13763, 5, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12613, 5, 'WF', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (14314, 5, 'M', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23442, 6, 'WF', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1655', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23445, 6, 'MWF', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1655', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23449, 6, 'WR', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13779, 5, 'W', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1335', '%k%i')), TIME(STR_TO_DATE('1625', '%k%i')), 9);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22356, 6, 'W', TIME(STR_TO_DATE('1835', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22357, 6, 'W', TIME(STR_TO_DATE('1935', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22358, 6, 'F', TIME(STR_TO_DATE('1835', '%k%i')),
        TIME(STR_TO_DATE('1925', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22359, 6, 'F', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22362, 6, 'F', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22363, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13805, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22459, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1225', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22466, 6, 'M', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1055', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22468, 6, 'M', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22470, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13826, 5, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (13828, 5, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23509, 6, 'M', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23512, 6, 'F', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23515, 6, 'T', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12768, 5, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12769, 5, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12770, 5, 'R', TIME(STR_TO_DATE('0905', '%k%i')),
        TIME(STR_TO_DATE('0955', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12772, 5, 'F', TIME(STR_TO_DATE('1705', '%k%i')),
        TIME(STR_TO_DATE('1855', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12774, 5, 'R', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12775, 5, 'T', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12776, 5, 'TR', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12778, 5, 'W', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12779, 5, 'M', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22485, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22486, 6, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22487, 6, 'M', TIME(STR_TO_DATE('1335', '%k%i')),
        TIME(STR_TO_DATE('1455', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22489, 6, 'W', TIME(STR_TO_DATE('1505', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22491, 6, 'M', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22492, 6, 'F', TIME(STR_TO_DATE('0805', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22493, 6, 'T', TIME(STR_TO_DATE('1205', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12807, 5, 'R', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12809, 5, 'W', TIME(STR_TO_DATE('0905', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22523, 6, 'T', TIME(STR_TO_DATE('0835', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22526, 6, 'R', TIME(STR_TO_DATE('0905', '%k%i')),
        TIME(STR_TO_DATE('1155', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22528, 6, 'M', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (12863, 5, 'T', TIME(STR_TO_DATE('1935', '%k%i')),
        TIME(STR_TO_DATE('2025', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23918, 6, 'W', TIME(STR_TO_DATE('1535', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23919, 6, 'F', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1525', '%k%i')), 1);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1835', '%k%i')), TIME(STR_TO_DATE('1925', '%k%i')), 3);

INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22574, 6, 'W', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22684, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22685, 6, 'R', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22686, 6, 'T', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22687, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22688, 6, 'T', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22692, 6, 'M', TIME(STR_TO_DATE('1735', '%k%i')),
        TIME(STR_TO_DATE('1825', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22694, 6, 'M', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22695, 6, 'M', TIME(STR_TO_DATE('1235', '%k%i')),
        TIME(STR_TO_DATE('1325', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22707, 6, 'W', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22708, 6, 'M', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22709, 6, 'R', TIME(STR_TO_DATE('1135', '%k%i')),
        TIME(STR_TO_DATE('1255', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22710, 6, 'T', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22711, 6, 'T', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22712, 6, 'T', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22713, 6, 'R', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1555', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22714, 6, 'R', TIME(STR_TO_DATE('1005', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22715, 6, 'R', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22716, 6, 'M', TIME(STR_TO_DATE('1605', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22719, 6, 'T', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22720, 6, 'W', TIME(STR_TO_DATE('1435', '%k%i')),
        TIME(STR_TO_DATE('1625', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22721, 6, 'M', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);

        
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (22722, 6, 'W', TIME(STR_TO_DATE('0935', '%k%i')),
        TIME(STR_TO_DATE('1125', '%k%i')), 1);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23863, 6, 'T', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23865, 6, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23868, 6, 'MW', TIME(STR_TO_DATE('1635', '%k%i')),
        TIME(STR_TO_DATE('1725', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23870, 6, 'F', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23873, 6, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO labInfo (L_CRN, T_CODE, L_DAYS, L_TIMESTART, L_TIMEEND, L_IS_TUTORIAL)
        VALUES (23875, 6, 'R', TIME(STR_TO_DATE('1305', '%k%i')),
        TIME(STR_TO_DATE('1425', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('0935', '%k%i')), TIME(STR_TO_DATE('1125', '%k%i')), 0);
...
INSERT INTO classInfo (C_CRN, T_CODE, C_CODE, C_NAME, D_CODE, C_DAYS, C_TIMESTART,
        ...
        TIME(STR_TO_DATE('1305', '%k%i')), TIME(STR_TO_DATE('1425', '%k%i')), 0);
